...
@telebot.on(admin_cmd(outgoing=True, pattern="savefilter (.*)"))
...
@telebot.on(admin_cmd(outgoing=True, pattern="listfilters"))
...
@telebot.on(admin_cmd(outgoing=True, pattern="clearfilter (.*)"))
...
@telebot.on(admin_cmd(outgoing=True, pattern="clearallfilters"))
