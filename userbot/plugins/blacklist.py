...
@telebot.on(admin_cmd(outgoing=True, pattern="addblacklist ((.|\n)*)"))
...
@telebot.on(admin_cmd(outgoing=True, pattern="listblacklist"))
...
@telebot.on(admin_cmd(outgoing=True, pattern="rmblacklist ((.|\n)*)"))
